...
export default class Scene {
  ...
  cameraMovedHandler () {
    ...
    // update the map of objects to render on the scene
    this.updateMap(this.camera.position)
  ...
  setup () {
    ...
    this.drawHexes()
    this.mapChunks()
    this.hexGrid = new HexGrid(this.hexGridSize, this.hexGridOffset, this.hexGridHeight, this.hexGridWidth, this.hexGridDepth, this.hexGridHeight)
    this.updateMap(this.camera.position)
    this.drawMap()
    this.drawChunks()
    this.drawChunkBorders()
    this.drawChunkCorners()
    this.drawChunkEdges()
    this.drawChunkFaces()
    this.drawChunkVertices()
  }

  drawMap () {
    // draw the hexagon grid
    this.hexGrid.draw(this.scene)
  }
